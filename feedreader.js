...
$(function() {
    ...
    describe('RSS Feeds', function() {
        ...
        it('will loop through allFeeds to check url', function() {
        ...
        it('will loop through allFeeds to check name', function() {
            allFeeds.forEach(function(feed) {
    ...
    describe('The Menu', function() {
        ...
        it('check menu is hidden by default', function() {
    ...
    describe('Initial Entries', function() {
        ...
        it('check feed container for at least 1 element', function() {
    ...
    describe('New Feed Selection', function() {
        ...
        it('check content change', function(done) {
            loadFeed(0, function() {
